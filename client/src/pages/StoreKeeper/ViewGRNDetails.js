...
//Style
import style from './ViewGRNDetails.module.scss';
...
export default function ViewGRNDetails() {
    ...
    const { control, getValues } = useForm({
        defaultValues: {
            ponumber: JSON.parse(localStorage.getItem(grnnumberginnumber)).ponumber,
            grnnumber: JSON.parse(localStorage.getItem(grnnumberginnumber)).grnnumber,
            supplier: JSON.parse(localStorage.getItem(grnnumberginnumber)).supplier,
            pototal: JSON.parse(localStorage.getItem(grnnumberginnumber)).pototal,
            status: JSON.parse(localStorage.getItem(grnnumberginnumber)).status,
            givenid: JSON.parse(localStorage.getItem(grnnumberginnumber)).givenid,
            ...
            damagedmissingitems: JSON.parse(localStorage.getItem(grnnumberginnumber)).damagedmissingitems,
            grntotal: JSON.parse(localStorage.getItem(grnnumberginnumber)).grntotal,
    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.header}>
                ...
                <div>
                    GRN Number: <span className={style.blue}>{grnnumberginnumber}</span>
                </div>
                <div>
                    <HighlightOffIcon
            ...
            <div className={style.body}>
                ...
                <div className={style.rowTwo}>
                    ...
                    <AutoSizer>
                        {({ height, width }) => {
                            const pageSize = Math.floor((height - 271) / 48);
